...
export class FilterComponent implements OnInit {
  ...
  @ViewChild('sortByDate') public sortByDateButtonTitle: ElementRef;
  @ViewChild('sortByViews') public sortByViewsButtonTitle: ElementRef;
  ...
  public sortByDate(): void {
    this.youtubeService.changeSortByDateStrategyNumber(
      this.sortDateCounter % 3
    );
    this.sortDateCounter++;
  }
  public sortByViews(): void {
    this.youtubeService.changeSortByViewsStrategyNumber(
      this.sortViewsCounter % 3
    );
